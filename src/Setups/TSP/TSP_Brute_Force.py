...
def build_graph(data):
    ...
    for pt in range(len(data)):
        ...
        for next_pt in range(len(data)):
            # don't calculate distance between a city and itself, don't calculate
            # distance between two cities if that distance already calculated
