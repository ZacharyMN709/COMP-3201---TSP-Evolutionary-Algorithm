...
class EATester(EARunner):
    ...
    def iterate_tests(self, generation_limit, known_optimum=None, true_opt=False, print_gens=False):
        ...
        def print_final(v, w, x, y, z, a):
            ...
            print("Average fitness: {}\nBest fitness: {}".format(mean, best))
            if true_opt:
                print("Average solution {:4.2f}% larger than true optimum.\n\
                Best solution {:4.2f}% larger than true optimum.".format(mean_per, best_per))
            print("Total 'best' individuals: {}\n\
            Total generations elapsed: {} generations\n\
            Total time elapsed: {} seconds\n\
            \n -------- \n".format(solutions, generations, runtime))
